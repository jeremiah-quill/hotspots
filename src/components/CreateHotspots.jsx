    ...
    <div className="grid grid-rows-2 md:grid-cols-2 md:grid-rows-1 h-full">
      <div className="bg-green-200 grid place-items-center p-4 relative">
        ...
        <div
          ...
          } w-full max-w-3xl border-dashed border-2 border-slate-700 rounded-xl m-auto overflow-hidden`}>
          <HotspotImage src={imageUrl} hotspots={hotspots} />
        </div>
      </div>
      <div className="bg-blue-200 p-4 grid place-items-center h-full">
        <div>
          <button
